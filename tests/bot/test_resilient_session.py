...
class TestCreateBotSession:
    ...
    def test_with_proxy_and_resilience(self) -> None:
        ...
        cfg = ResilienceConfig()
        with patch("ductor_bot.bot.session_factory.AiohttpSession.__init__", return_value=None):
    ...
    def test_with_proxy_no_resilience_returns_aiohttp_session(self) -> None:
        ...
        with patch("ductor_bot.bot.session_factory.AiohttpSession") as MockSession:
