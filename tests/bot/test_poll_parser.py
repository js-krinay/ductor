...
class TestPollParser:
    def test_parse_basic_poll(self) -> None:
        from ductor_bot.bot.poll_parser import PollDirective, parse_polls
    ...
    def test_parse_no_poll(self) -> None:
        from ductor_bot.bot.poll_parser import parse_polls
    ...
    def test_strip_directives_from_text(self) -> None:
        from ductor_bot.bot.poll_parser import strip_polls
