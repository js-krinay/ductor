...
class TestShouldAlert:
    ...
    def test_custom_alert_after(self):
    ...
    def test_malformed_last_alert_at_triggers_alert(self):
...
class TestFormatFailureAlert:
    ...
    def test_contains_last_error(self):
