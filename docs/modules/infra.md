...
- macOS/Windows: file tail from `~/.klir/logs/agent.log` (fallback newest `*.log`)
...
Centralised loading of user-defined API secrets from `~/.klir/.env`.
